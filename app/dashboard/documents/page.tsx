  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        ...
        {/* Smart Upload Banner */}
        <div className="mb-8 p-5 rounded-xl bg-gradient-to-r from-indigo-50 to-blue-50 border border-indigo-200">
          <div className="flex items-center justify-between">
            <div className="flex gap-4">
              ...
              <div>
                <p className="text-base font-semibold text-indigo-900">Smart Upload</p>
                <p className="text-sm text-indigo-700 mt-0.5">
                  Drop any documents and our AI will automatically classify and organize them for your offering.
                </p>
              </div>
            </div>
            <Button
